    ...
    <>
      ...
      <section className='container-wide px-fluid-lg py-fluid-5xl flex flex-col md:flex-row gap-fluid-4xl items-start relative'>
        <div className='md:w-3/5'>
          ...
          <p>
            Are you wondering &ldquo;What can I do with a business
            degree?&rdquo; or &ldquo;What can I do with a master&apos;s in
            business?&rdquo; <strong>Our free quiz will help you</strong>{' '}
            discover the right degree path and career opportunities tailored to
            your interests and goals. The Bureau of Labor Statistics predicts
            that nearly one million jobs in business will be created each year
            over the next decade. Many colleges and universities offer flexible,
            affordable degrees or certificates that can give you a head start in
