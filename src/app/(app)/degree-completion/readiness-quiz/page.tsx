			...
			<div className="quiz-wrapper">
				<section className="quiz-container group row cols-2">
					<div className="column">
						...
						<p>Earning a degree is a big step with lots of benefits:</p>
						<ul>
							<li>
								<strong>Higher Earnings:</strong> More money in the long run (up
								to 66% more!).
							</li>
							<li>
								<strong>Better Opportunities:</strong> Access to great jobs and
								careers.
							</li>
							<li>
								<strong>Stability:</strong> A steadier and more secure future.
							</li>
							<li>
								<strong>Personal Growth:</strong> Learn new things and think in
								new ways.
							</li>
						</ul>
						<p>
