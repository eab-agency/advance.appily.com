          ...
          <div className="group cols-2">
            ...
            <div className="column">
              ...
              <div className="path-intro">
                ...
                <p>
                  Occupations that align with The Scientist’s career path conduct
                  research aimed at improving overall human health. They often use
                  clinical trials and other investigative methods to research
                  their findings.
                </p>
              </div>
              <div className="executive-path">
                <ul>
                  <li>
                    ...
                    role in identifying and treating cancerimport heart disease,
