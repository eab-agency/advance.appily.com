							...
							<div className={styles.pathwrapper}>
								<ul>
									<li>
										...
										serve. They identify health-related issues, collect data,
										and discuss health concerns with the community. They work
										with health education specialists and social services to
										inform programs that address the health and wellness needs
										of their community.
									</li>
									<li>
