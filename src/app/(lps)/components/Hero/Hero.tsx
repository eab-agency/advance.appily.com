...
export const Hero = () => {
  	return (
      <section className="relative w-full bg-brand-lightteal bg-[url(/images/teal-texture.svg)]">
        <div className="w-full lg:container-wide flex flex-col gap-fluid-xl lg:flex-row items-center pt-0 pb-fluid-xl lg:py-[15vw] xl:py-[10vw]">
          <div className="px-fluid-lg w-[90%] py-fluid-xl lg:py-0 lg:w-1/2 xl:w-2/3 order-1 lg:order-0">
